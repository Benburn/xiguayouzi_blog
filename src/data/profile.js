...
`,
  ...
  // —— 医学影像 ——
  {
    ...
    title: "华斌笔记",
    excerpt:
      "华斌超声笔记系列在线整理版，第2辑与第3辑已上线，覆盖腹部、介入、胸肺、血管、甲状腺、乳腺、淋巴结及阴囊等主题。",
    date: "2026-07-22",
    readTime: "已上线2辑",
    cover: null,
    tags: ["华斌笔记", "超声学习", "医学影像"],
...
这是一个持续更新的超声笔记系列入口。全系列规划为 **6 辑**，目前第2辑和第3辑已经上线，其余四辑已经预留位置，后续内容将继续整合到同一项目中。
...
第3辑共 **6章92节**，正文范围为 P19–P276，共250个页面块和361张正文图片；已清理明显的OCR异常字符，图片保留在对应章节和图注附近。
