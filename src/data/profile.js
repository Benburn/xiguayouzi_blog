...
`,
  },
  {
    ...
    title: "超声医学规培三件套",
    excerpt:
      "系统教材与两套《住院医师规范化培训超声医学科示范案例》的统一学习入口，按需进入三套独立在线阅读内容。",
    date: "2026-07-16",
    readTime: "2 分钟",
    cover: null,
    tags: ["超声医学", "规培", "教材", "示范案例", "实践考核"],
    body: `# 超声医学规培三件套

将原有的《超声医学（第2版）》在线学习版，与两套住院医师规范化培训案例合并为一个学习入口。三套内容彼此独立，方便按“教材—示范案例—实践考核”的路径切换学习。

## 三个阅读入口

- **超声医学（第2版）在线学习版**：系统教材、章节导航、全文搜索与原书插图；
- **住院医师规范化培训超声医学科示范案例2016版**：127 个示范案例、468 幅图像，支持自测与答案展开；
- **住院医师规范化培训超声医学科示范案例2024版**：264 个实践案例、1,224 幅图像，支持分类导航与图像放大。

## 使用说明

三个入口均已本地化图片资源，适配电脑、平板和手机端阅读。内容仅供医学教育与个人学习使用；涉及临床判断时，请结合权威教材、指南与上级医师意见进行核对。

<p><a class="knowledge-card-launch" href="/ultrasound-residency-training-kit/index.html">打开“超声医学规培三件套” <span>→</span></a></p>

> 内容仅供学习交流，不构成诊断、治疗或操作建议。
`,
  },
  {
